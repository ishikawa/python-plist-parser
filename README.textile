...
This is a Python parser class for Apple's "Property Lists":http://developer.apple.com/documentation/Cocoa/Conceptual/PropertyLists/ XML. A Property Lists is a data representation used in Apple's Mac OS X as a convenient way to store standard object types, such as string, number, boolean, and container objects (dictionary and array). Either datetime and binary data are also supported.
